...
Savunma: 3.1.3(f) companion + 1:1 seans 3.1.3(d). Mevcut web Stripe üyeliği görünür; iptal/kart Portal (yeni satış değil).
...
```
Yeni Form, yeniform.com web hizmetinin iOS companion uygulamasıdır (Guideline 3.1.3(f)). Dijital üyelik App Store I’da satılmaz; uygulamada satın alma butonu, harici checkout CTA’sı ve StoreKit yoktur. Web’den alınmış üyelik e-posta/şifre ile açılır. Mevcut Stripe aboneliğinin iptali / kartı Stripe Customer Portal’dadır (yeni satış değil).
