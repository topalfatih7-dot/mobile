...
Ödeme: uygulama içi IAP **yok**. iOS binary’de web `/plans` / `/membership` satın alma CTA **yok** (Guideline 3.1.3(f) companion). Mevcut web Stripe üyeliği + iptal/kart Portal durur. Android’de web CTA kalır.
...
3. iOS: **Web’den paket ekle / Planları İncele / Plan Seç** yok; mevcut paket kartı + iptal/kart durur
