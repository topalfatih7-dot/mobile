# Appendix F — Handoff Checklist

Kodlamaya başlamadan:

- [ ] Read `docs/mobile/IMPLEMENTATION-LOCK.md`
- [ ] Read `.cursor/skills/README.md` + `yeniform-mobile-router`
...
- [ ] Every P0 screen has acceptance criteria
- [ ] API contracts match deployed Vercel routes
- [ ] Legal consents present in onboarding
