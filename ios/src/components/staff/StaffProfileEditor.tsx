...
import { WeeklyAvailability } from '@/components/staff/WeeklyAvailability';
...
function titlePlaceholderForRole(role: unknown) {
  const r = String(role || 'coach').toLowerCase();
  if (r === 'dietitian' || r === 'diyetisyen') return 'uzman diyetisyen';
  if (r === 'doctor' || r === 'doktor') return 'uzman doktor';
  return 'uzman koç';
}
        ...
        <ProfileSectionCard
          ...
          <View style={styles.sectionGap}>
            ...
            <TextField
              ...
              placeholder={titlePlaceholderForRole(form.role || staffUser.role)}
