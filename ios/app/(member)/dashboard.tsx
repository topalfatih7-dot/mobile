...
import { getHealthTestLockState, resolveMemberBrief } from '@/services/healthScoreAnalysis';
    ...
    <MeshBackground style={styles.root}>
      <ScrollView
        ...
        <FadeIn delay={40}>
          <View style={styles.hero}>
            ...
            <View style={styles.heroContent}>
              ...
              <Text
                numberOfLines={2}
                style={[styles.heroTitle, isNarrow && styles.heroTitleNarrow, { fontSize: t.ms(isNarrow ? 20 : 22) }]}>
                {firstName}, bugün güzel bir gün
              </Text>
        ...
        {healthAnalysisReady ? (
          <FadeIn delay={90}>
            <MemberHealthBrief
              brief={resolveMemberBrief(healthAnalysis)}
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text style={styles.bannerSub}>
                  {offerWebPurchase
                    ...
                    : 'Son gün dahil erişiminiz sürer.'}
                </Text>
              </View>
              {offerWebPurchase ? (
              <Pressable
          ...
          <FadeIn delay={110}>
            <View style={styles.bannerBrand}>
              <View style={{ flex: 1 }}>
                ...
                {!offerWebPurchase ? (
                  <IosOutOfAppPurchaseNotice style={styles.bannerNotice} />
                ) : null}
              </View>
              {offerWebPurchase ? (
              <Pressable
...
const styles = StyleSheet.create({
  root: { flex: 1 },
  content: { paddingHorizontal: spacing.lg, gap: spacing.lg, width: '100%' },
  hero: {
    minHeight: 200,
