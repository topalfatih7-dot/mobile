...
/** LOCK: docs/mobile/screens/member/video-call.md */
export default function MemberVideoCall() {
  ...
  const backHref = `/(member)/schedule?tab=${normalizedType}` as Href;

  useIntervalWhileActive(() => setClock((value) => value + 1), 30_000, true, {
    requireFocus: true,
  });
