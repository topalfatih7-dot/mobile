...
import { syncEngagementReminders, cancelHabitReminders, resetEngagementSyncCache, engagementFingerprint } from '@/services/engagementReminders';
...
function MemberPushBootstrap() {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      if (alive && isPushNotificationsEnabled(settings)) {
