    ...
    return (
      <MeshBackground style={styles.root}>
        <ScrollView
          ...
          <UnpaidMemberGate
            description="Sayfayı gezebilirsiniz. Hareket videoları bu pakette yer almaz."
          ...
          <View style={styles.headerBlock}>
            ...
            {fullLibrary || programExerciseIds.length > 0 ? (
              <>
                ...
                {filtersOpen ? (
                  <Animated.View entering={enteringNative(ReFadeIn.duration(180))} exiting={enteringNative(ReFadeOut.duration(140))} style={styles.filters}>
