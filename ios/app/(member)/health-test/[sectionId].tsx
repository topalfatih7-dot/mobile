    ...
    <MeshBackground style={styles.root}>
      <FormKeyboardScroll
        ...
        <FadeIn>
          ...
          <Text
            numberOfLines={2}
            style={[styles.title, { fontSize: t.type.xl, lineHeight: t.ms(28) }]}>
            {section?.title}
          </Text>
          {section?.subtitle ? (
            <Text style={[styles.subtitle, { fontSize: t.type.sm }]}>
              {section.subtitle} (opsiyonel)
            </Text>
          ) : (
            <Text style={[styles.subtitle, { fontSize: t.type.sm }]}>Opsiyonel sorular</Text>
          )}
        </FadeIn>
...
const styles = StyleSheet.create({
  root: { flex: 1 },
  content: { paddingHorizontal: spacing.lg, gap: spacing.md, width: '100%' },
