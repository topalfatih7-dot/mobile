    ...
    <MeshBackground style={styles.root}>
      <FormKeyboardScroll
        ...
        <FadeIn>
          ...
          <Text style={[styles.subtitle, { fontSize: t.type.sm, lineHeight: t.ms(20) }]}>
            {subtitle}
          </Text>
        </FadeIn>
...
const styles = StyleSheet.create({
  ...
  stageStack: { gap: spacing.lg, width: '100%' },
  title: {
  ...
  stageHeader: { flexDirection: 'row', gap: spacing.md, alignItems: 'flex-start' },
  stageEyebrow: {
  ...
  doneRow: { flexDirection: 'row', alignItems: 'center', gap: 8, minWidth: 0 },
  doneTitle: {
    fontFamily: fonts.sansSemi,
    fontSize: 14,
    color: colors.cream[900],
