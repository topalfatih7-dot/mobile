...
**MOBILE DIFF (2026-08-22) iOS:** `!hasManualCalorieAccess` kilidinde **Paketleri gör** yok; metin `iosCalorieLocked` (“plana geçin” yok). UnpaidMemberGate zaten iOS’ta Plan Seç göstermez.

**MOBILE DIFF (2026-08-26) iOS:** Composer + inverted liste `ChatKeyboardLayout` / `KeyboardDock` — klavye açılınca son balon input’un hemen üstünde kalır (mesaj thread ile aynı).
