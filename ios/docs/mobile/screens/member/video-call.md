...
- **MOBILE DIFF (2026-08-24) iOS:** canlı odada (Daily veya WebView) telefon yataya çevrilince tam ekran “Telefonu dik tutun” overlay’i; ses/görüntü kesilmez, dikeye dönünce kaybolur. Önizleme / izin ekranında yok. Orientation kilidi yok.
- **MOBILE DIFF (2026-08-29):** Daily native’de kamera yönü (`cycleCamera`, ön ↔ arka). Ön kamera local tile mirror; arka kamera mirror kapalı. Canlı odada kendi görüntüsü (PIP) sahne içinde sürüklenebilir; kenarlardan taşmaz, varsayılan sağ-alt. Boyut telefon genişliğine göre ölçeklenir (SE’de dar, Plus/Max’te biraz büyük, tablette tavan). WebView fallback Daily prebuilt UI kullanır (özel PIP/çevirme yok).
