...
export function PanelDrawer({
  ...
  useEffect(() => {
    if (open) {
      ...
      translateX.value = withTiming(-320, { duration: 220 });
          ...
          {onLogout ? (
            <View style={styles.footer}>
              <Pressable
                ...
                {loggingOut ? (
                  <ActivityIndicator color={colors.cream[800]} size="small" />
                ) : (
                  <Ionicons color={colors.cream[800]} name="log-out-outline" size={18} />
                )}
