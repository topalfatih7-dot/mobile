/**
 * LOCK: docs/mobile/screens/staff/notifications.md
 * Web: StaffNotificationsPage.jsx
 */
...
import { routeFromStaffPushData } from '@/services/push';
...
export default function StaffNotificationsScreen() {
  ...
  const all = useMemo(
    () =>
      getStaffNotificationsList(staff)
        .map(
          (n) =>
            ({
              ...n,
              id: String(n.id || ''),
              sessionId: n.sessionId != null ? String(n.sessionId) : undefined,
              sessionType: n.sessionType != null ? String(n.sessionType) : undefined,
            }) as Notif,
        )
        .filter((n) => n.id)
        .slice()
  ...
  const openNotif = async (n: Notif) => {
    ...
    const route = routeFromStaffPushData({
      type: n.type,
      memberId: n.memberId,
      threadId: n.threadId,
