...
function StaffPushBootstrap() {
  ...
  useEffect(() => {
    ...
    void (async () => {
      ...
      if (alive) scheduleAndroidBackgroundDeliveryPrompt();
    })();
...
export default function StaffLayout() {
  ...
  const threadCacheRef = useRef<Map<string, import('@/services/chat').ChatThread>>(new Map());
  ...
  const reloadBadges = useCallback(async () => {
    ...
    try {
      ...
      const map = new Map<string, import('@/services/chat').ChatThread>();
