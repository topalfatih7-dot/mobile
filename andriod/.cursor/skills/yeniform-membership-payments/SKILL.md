...
- **Mobile:** No App Store / Play IAP. Android: packages + Stripe Portal + logged-in web `/plans`. **iOS:** no purchase CTA (`canOfferWebPurchase`); **no payment management UI** (2026-08-22 — drawer/payments/Portal hidden; redesigned later). 3.1.3(f).
