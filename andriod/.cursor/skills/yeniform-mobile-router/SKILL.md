...
- Payments: web Stripe only. Purchase CTA → login’li `/plans`. Cancel/manage → native warning + Portal (`yeniform-membership-payments`). Entitlement in Supabase `members`. No RevenueCat/IAP.
