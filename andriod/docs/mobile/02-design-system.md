...
- Ölçeklenmez: `borderWidth: 1`, hairline, elevation, yüzde genişlik
- Dokunma: ölçek sonrası min 44; birincil CTA min 48
- Sistem yazı: **kapalı** — `allowFontScaling={false}`, `maxFontSizeMultiplier = 1`. Telefon yazı boyutu uygulamayı değiştirmez.
- Fold / tablet 2 kolon: yok — yalnız token ölçeği  
