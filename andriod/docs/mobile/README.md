...
| `store/` | Play mağaza: [`store/android-play-store.md`](store/android-play-store.md), [`store/android-play-forms.md`](store/android-play-forms.md), [`store/android-listing.tr.md`](store/android-listing.tr.md), [`store/play-data-safety.csv`](store/play-data-safety.csv) |
