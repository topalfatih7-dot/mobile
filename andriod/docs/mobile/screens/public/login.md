...
**MOBILE DIFF (2026-08-24):** Kartın üstünde marka logosu. Form dikey ortalanır; geniş ekranda max-width. Ana ekran butonu yok.
...
Klavye: `FormKeyboardScroll` (`react-native-keyboard-controller`). iOS overlay + Android `adjustResize`. Native modül — Metro reload yetmez, **dev/preview client yeniden derlenmeli**.
