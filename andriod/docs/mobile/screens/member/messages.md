...
6. Composer (text-only): taller min height (~52); keyboard open keeps the latest bubble just above the composer (`ChatKeyboardLayout` / `KeyboardAvoidingView` padding around inverted list + composer)  
