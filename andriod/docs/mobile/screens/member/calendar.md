...
0. **Su takibi** compact karaf (web `MemberWaterTracker` size=compact) — gün detay scroll üstü. `local_date` = seçili gün. Domain `water-tracking.md`. Ay hücresinde su noktası yok.
