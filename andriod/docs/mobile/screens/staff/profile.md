...
- Çalışma: WeeklyAvailability (08–22), social links. **MOBILE:** `workDays` / `workStart` / `workEnd` chips and WhatsApp toggle are **not shown**; save still persists last stored `workDays`, `workStart`, `workEnd`, `settings.whatsappNotifs`
