...
4b. **Su takibi** `StaffWaterProgress` (bar + 7 gün; karaf yok). Hedef input yalnız dietitian/admin. Domain `water-tracking.md`.
...
6b. **Kan tahlilleri** `HealthLabFilesPanel` — `collectHealthLabFiles` boş değilse; **salt okunur** (açılır, yükleme/silme yok)
