...
export const MEMBERSHIP_CANCEL_COPY = {
  ...
  iosOnboardingSub: 'Hesabını oluştur; ücretsiz üye olarak devam et.',
  iosCalorieLocked:
    'Metin ile kalori analizi bu pakette yok. Üyelik bu uygulamada satılmaz.',
  iosScheduleLocked: {
    coach: 'Koç randevusu bu pakette yok. Üyelik bu uygulamada satılmaz.',
    dietitian:
      'Diyetisyen randevusu bu pakette yok. Üyelik bu uygulamada satılmaz.',
    doctor:
      'Doktor görüşmesi ayrı bir pakettedir. Üyelik bu uygulamada satılmaz.',
  },
