    ...
    <>
      ...
      <Modal
        ...
        <OverlayPortalProvider>
          <View style={Platform.OS === 'ios' ? styles.iosSheet : styles.backdrop}>
            <View
              style={[
                Platform.OS === 'ios' ? styles.iosModal : styles.modal,
                { paddingBottom: insets.bottom + spacing.md },
              ]}>
              {Platform.OS !== 'ios' ? <View style={styles.handle} /> : null}
              <Text style={styles.modalTitle}>Kişisel Bilgiler</Text>
            <FormKeyboardScroll contentContainerStyle={styles.modalScroll}>
              <Pressable
              ...
              {saving || uploadingPhoto ? (
                <View pointerEvents="auto" style={styles.savingMask}>
                  <BrandLoader
                    label={uploadingPhoto ? 'Fotoğraf yükleniyor…' : 'Kaydediliyor…'}
                    size="md"
                  />
                </View>
              ) : null}
...
const styles = StyleSheet.create({
  ...
  iosSheet: { flex: 1, backgroundColor: colors.white },
  iosModal: { flex: 1, backgroundColor: colors.white, paddingTop: spacing.md },
  savingMask: {
